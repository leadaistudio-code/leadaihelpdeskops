        ...
        <form action={handleCreate} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <input type="hidden" name="callerId" value={user.id} />
              <input type="text" disabled value={`${user.name} (${user.role})`} className="w-full px-3 py-2 border border-slate-300 bg-slate-100 rounded shadow-sm text-sm text-slate-500 cursor-not-allowed" />
            </div>
