...
export function LogoMark({
  ...
  return (
    ...
    >
      <g stroke="#00b48a" strokeWidth="2.6" fill="none" strokeLinejoin="round" strokeLinecap="round">
        <path d="M50 20 L82 38 L50 56 L18 38 Z" />
        <path d="M82 38 L82 72 L50 90 L50 56" />
        <path d="M18 38 L18 72 L50 90" />
      </g>
      <line x1="50" y1="56" x2="50" y2="90" stroke="#00d4a4" strokeWidth="2.6" strokeLinecap="round" opacity="0.9" />
      <g fill="#00d4a4">
      ...
      <circle cx="50" cy="56" r="11" fill="none" stroke="#00d4a4" strokeWidth="1.6" opacity="0.5" />
    </svg>
  );
}
    ...
    <span className={`inline-flex items-center gap-2.5 ${className}`}>
      ...
      {withWordmark && (
        <span className={`font-display font-extrabold tracking-tight text-[15px] leading-none ${wordClass}`}>
          Lead<span className="text-[#00926f]">AI</span>
